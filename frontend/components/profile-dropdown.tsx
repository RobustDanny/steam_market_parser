...
import { Wallet, Settings, LogOut, X, CreditCard, Bitcoin } from "lucide-react"
    ...
    return (
        <>
            ...
            <div className="fixed top-14 right-4 z-50 w-56 rounded-xl bg-card border border-border shadow-2xl shadow-black/40 overflow-hidden">
                {/* Budget - clickable to open wallet popup */}
                <button
                    onClick={() => setWalletOpen(!walletOpen)}
                    className="w-full px-4 py-3 border-b border-border hover:bg-secondary/30 transition-colors text-left"
                >
                ...
                <div className="py-1">
                    ...
                    <button className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-destructive hover:bg-secondary/30 transition-colors">
            ...
            {/* Wallet popup - shows balance per connected method */}
            {walletOpen && (
